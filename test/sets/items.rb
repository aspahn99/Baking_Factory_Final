  ...
  module Items
    ...
    def create_breads
      @honey_wheat = FactoryBot.create(:item, 
        ...
        category: "bread", 
        weight: 1.0,
        picture: "products/honey_wheat.jpg")
      ...
      @cinnamon_swirl = FactoryBot.create(:item, 
        ...
        category: "bread", 
        weight: 1.0,
        picture: "products/cinnamon_bread.jpeg")
      ...
      @apple_cherry = FactoryBot.create(:item, 
        ...
        weight: 1.2,
        active: false,
        picture: "products/apple_bread.jpeg")
      ...
      @sourdough = FactoryBot.create(:item, 
        ...
        category: "bread", 
        weight: 1.1,
        picture: "products/sourdough.jpeg")
    ...
    def create_muffins
      @blueberry = FactoryBot.create(:item, 
        ...
        category: "muffins", 
        weight: 1.0,
        picture: "products/blueberry_muffin.jpeg")
      ...
      @chocolate_zuke = FactoryBot.create(:item, 
        ...
        category: "muffins", 
        weight: 1.1,
        picture: "products/chocolate_muffin.jpeg")
      ...
      @apple_carrot = FactoryBot.create(:item, 
        ...
        weight: 1.1,
        active: false,
        picture: "products/apple_muffin.jpg")
    end
    ...
    def create_pastries
      @croissants = FactoryBot.create(:item, 
        ...
        category: "pastries", 
        weight: 1.0,
        picture: "products/croissant.jpeg")
    end
